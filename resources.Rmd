...
This is a list of the data sources used in this workshop. For live-coding, please refer to this [**link**](https://dl.dropboxusercontent.com/s/odkuptfvl5kqskt/2018-R-DAVIS-w1.R?dl=0)), which will update everytime we save a file. That means you can refresh the page to see whatever code we are typing, and download this file at anytime.

 - [Full Dataset as a zipped folder](https://github.com/SCCWRP/CABW2018_R_training/raw/update_mapping/data/datazip.zip). Inside you'll find these files:
