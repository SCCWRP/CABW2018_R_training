...
```{r frogfig, results="asis", warnings=FALSE, messages=FALSE, echo=FALSE, out.height = '70%', fig.cap='Hanging on still?'}
...
### Static Map
 ...
 > **Challenge**: Can you make the same map as above (minus the background stuff and interactivity) using ggplot? Hint, `viridis` may be useful here...
